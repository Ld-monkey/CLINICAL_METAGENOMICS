...
.. warning::
   Dans la majorité des programmes présentés dans les sessions suivantes, il est possible de consulter les paramètres précis d'un programme en ajoutant la comme -h pour help comme illustré ci-contre.
