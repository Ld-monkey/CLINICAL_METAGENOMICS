...
# parameter --fastq-input for classify FASTQ
# compressed input --gzip-conpressed or --bzip2-compressed


# to build a custom database we need
# 1 install a taxonomy with NCBI taxonomy
...
# RefSef human: GRCh38 human genome/proteins + Virus + FDA
...
# After created database we can classify a set of sequences with
